...
const CreateQuotePage = ({ onSuccess }) => {
  const { api } = useAuth();
  const initialValues = { content: '', tags: '' };
        ...
        {({ isSubmitting }) => (
          <Form>
            <div className="form-group">
              ...
              <Field as="textarea" name="content" className="form-input textarea" placeholder="The greatest glory in living lies not in never falling, but in rising every time we fall." />
            ...
            <div className="form-group">
              ...
              <Field type="text" name="tags" className="form-input" placeholder="#wisdom, #life, #motivation" />
